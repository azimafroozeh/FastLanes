...
CLIArgs parse_cli_args(int argc, char* argv[]) {
	...
	args.comparison_type   = enums_nvcomp::string_to_comparison_type(argv[++arg_counter]);
	args.decompressor_enum = enums_nvcomp::string_to_compression_type(argv[++arg_counter]);
...
template <typename T>
void execute_benchmark(CLIArgs args) {
