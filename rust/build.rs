...
//!
//! • Inside the FastLanes git repo   -> build the directory one level up.
//! • Inside a crates.io tar-ball     -> unpack the embedded sources
...
/// Embedded FastLanes sources generated by `make package-fastlanes`
